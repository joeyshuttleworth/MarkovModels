...
def draw_likelihood_surface(funcs, paras, params_to_change, ranges, data, args, output_dir=None):
    ...
    mle, val = fit_model(funcs, data, paras, fix_parameters=fix_params, max_iterations=args.max_iterations)
...
def main():
    ...
    parser.add_argument("--max_iterations", default=None, help="The maximum number of iterations to use when performing the optimisation", type=int)
    ...
    funcs = MarkovModel(par, p, y, v, A, B, para, times, voltage=staircase_protocol)
